...
import cc.tanza.dashi.HttpConstants.StatusCode;
...
import static cc.tanza.dashi.HttpConstants.Header.DATE;
import static cc.tanza.dashi.HttpConstants.Header.SERVER;
import static cc.tanza.dashi.HttpConstants.StatusCode.BAD_REQUEST;
import static cc.tanza.dashi.HttpConstants.StatusCode.OK;
...
public class Response {
    ...
    private String formatStatusLine() {
        return statusCode != null
            ? VERSION + statusCode + Headers.CRLF
            : VERSION + formatCustomStatusCode(customStatusCode) + Headers.CRLF;
    }
    ...
    public String toString() {
        ...
        String resp = formatStatusLine() + headers.toString() + Headers.CRLF;
